      ...
      ?>">
        ...
        <div class="navbar-nav-scroll ml-auto mr-auto">
          <ul class="navbar-nav bd-navbar-nav flex-row menu-home">
                ...
                <div class="sub-menu-container">
                  <div class="row h-100">
                    <div class="col-sm-5 left-side">
                        ...
                        <a href="<?php bloginfo('url');?>/invest">LEARN MORE</a>
                    </div>
            ...
            <li class="nav-item">
              <a class="nav-link active" href="<?php bloginfo('url');?>/pricing" id="pricing-option">Pricing</a>
            </li>
            <!-- <li class="nav-item">
        ...
        <ul class="navbar-nav flex-row d-none d-md-flex right-menu">
          <li class="nav-item">
            <a class="nav-link active" href="<?php bloginfo('url');?>/login-page" >Login</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" target="_blank" href="https://www.clientam.com/sso/Login?partnerID=Uplift" >IB</a>
          </li>
          <li class="nav-item">
