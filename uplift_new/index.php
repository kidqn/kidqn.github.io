        ...
        <section id="banner-video">
            ...
            <div class="container uplift-container">
              <div class="head-info">
                  ...
                  <a class="btn btn_round btn_round-green" href="<?php bloginfo('url');?>/invest" id="discovery-today">DISCOVER UPLIFT TODAY</a>
              </div>
            </div>
        </section>
        <section id="about">
        ...
        <section id="embrace-your-power">
            <div class="container uplift-container">
              ...
              <div class="how-it-works">
                ...
                <div class="nav-bottom"><a href="<?php bloginfo('url');?>/invest">SEE HOW IT WORKS</a></div>
              </div>
            </div>
        </section>
