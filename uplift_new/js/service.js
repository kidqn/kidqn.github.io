...
$(function(){
  ...
  //---------//
  $( "input[type=checkbox]").after( "<span class=\"checkboxmark\"></span>" );
  $( "input[type=checkbox]").parent().addClass('container-checkbox');
  
  $( "input[type=radio]").after( "<span class=\"radiomark\"></span>" );
  $( "input[type=radio]").parent().addClass('container-radio');
})
